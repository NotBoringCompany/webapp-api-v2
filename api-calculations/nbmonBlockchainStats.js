 ...
 * @returns {String} the gender of the NBMon.
 */
 ...
 * @returns {String} the rarity of the NBMon.
 */
 ...
 * @returns {String} the genus of the Genesis NBMon.
 */
 ...
 * @returns {String} The mutation type of the NBMon if applicable.
 */
        ...
        if (mutationRand >= 996) {
            ...
            results.forEach((result) => {
                ...
                if (result.properties['Official Name'].title[0].plain_text.toLowerCase() === genus.toLowerCase()) {
                    ...
                    // same like the above check, we don't want the user to lose their mutated NBMon. We temporarily return this string which will prompt them to contact us.
                    if (possibleMutations[mutationTypeRand].name === undefined || possibleMutations[mutationTypeRand].name === null || possibleMutations[mutationTypeRand].name === '') {
                        return 'NBMon mutated, but no available mutations specified for that genus yet. Please contact the developers.';
                    }
 ...
 * @returns {Object} the two passives the Genesis NBMon will obtain.
 */
const randomizePassives = async () => {
    try { 
        ...
        // there is a possibility that some passives might accidentally have no name. in this case, we will return a string that says `passive name unavailable` to make aware of this.
